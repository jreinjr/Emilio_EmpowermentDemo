...
public class AttenuationProps : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(AttenuationProps obj) {
  ...
  public AttenuationProps(float minDistance, float maxDistance, float factor, bool maxDistanceMute) : this(Audio360CSharpPINVOKE.new_AttenuationProps__SWIG_1(minDistance, maxDistance, factor, maxDistanceMute), true) {
  }

  public AttenuationProps(float minDistance, float maxDistance, float factor) : this(Audio360CSharpPINVOKE.new_AttenuationProps__SWIG_2(minDistance, maxDistance, factor), true) {
  }
