...
public class NativeSpatDecoderQueue : SpatDecoderInterface {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(NativeSpatDecoderQueue obj) {
  ...
  public void setEventListener(NativeEventListener listener) {
    Audio360CSharpPINVOKE.NativeSpatDecoderQueue_setEventListener(swigCPtr, NativeEventListener.getCPtr(listener));
  }
